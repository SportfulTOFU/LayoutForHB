...
// const requireContext = require.context("D:/eclipse/layoutForHB/WebContent/电子地图", true, /\.markdown$/)
...
class AppDetail extends Component {
	constructor(props) {
		...
		var photosCollect = "";
		var data = {};
		const requireContext = require.context("D:/eclipse/layoutForHB/WebContent/电子地图/长江图", true, /^\.\/.*\.jpg$/);
	...
	render() {
      ...
      <MainBody className="mainbody row " apptype='appdetail' index={this.props.params.index_id}   data={this.state.data}/>
      </div >
		);
	}
};
